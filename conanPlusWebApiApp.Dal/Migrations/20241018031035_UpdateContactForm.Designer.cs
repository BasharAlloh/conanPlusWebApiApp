...
namespace conanPlusWebApiApp.Dal.Migrations
{
    ...
    [Migration("20241018031035_UpdateContactForm")]
            ...
            modelBuilder.Entity("conanPlusWebApiApp.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            EmployeeId = 1,
                            DateAdded = new DateTime(2024, 10, 18, 6, 10, 34, 38, DateTimeKind.Local).AddTicks(3460),
                        ...
                        {
                            EmployeeId = 2,
                            DateAdded = new DateTime(2024, 10, 18, 6, 10, 34, 38, DateTimeKind.Local).AddTicks(3466),
            ...
            modelBuilder.Entity("conanPlusWebApiApp.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            PasswordHash = "$2a$11$F/I.II1WpV1Z5x0nPcLkouKCsbwCswwxZ0UYmUVIvhSiSGQTvWhRG",
                            Role = "Admin",
                            TokenVersion = 1,
                            Username = "a"
                        });
